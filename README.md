...
![image_name](Images/Peak time for users.png)
...
![image_name](Images/Checkout time for users)
...
![image_name](Images/Checkout time for genders)
...
![image_name](Images/Trips by weekday per hour)
...
![image_name](Images/Trips be Gender (Weekday per Hour))
...
![image_name](Images/User trips by Gender(by weekday))
